...
def decrypt_folder(foldername, key):
    # if it's folder, decrypt the entire folder
    for child in pathlib.Path(foldername).glob("*"):
        if child.is_file():
...
if __name__=="__main__":
    import argparse
    parser = argparse.ArgumentParser(description="File Encryptor Scripts with a Password")
    ...
    if encrypt_ and decrypt_:
        raise TypeError("Please specifiy whether you want to encrypt the file or decrypt it.")
    elif encrypt_:
    ...
    """ The program for encryption and decryption of files/folder ends here."""


    #for encryption
    #python ransomware.py -e testfolder -s 32
    
    #for decryption
    #python ransomware.py -d testfolder